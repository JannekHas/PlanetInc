...
public class FiftyThousandClickAdvancement extends BaseAdvancement {
    public FiftyThousandClickAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
