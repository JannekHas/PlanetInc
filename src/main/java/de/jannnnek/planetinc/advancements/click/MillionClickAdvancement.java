...
public class MillionClickAdvancement extends BaseAdvancement {
    public MillionClickAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
