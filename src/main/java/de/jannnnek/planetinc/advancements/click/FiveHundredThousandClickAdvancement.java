...
public class FiveHundredThousandClickAdvancement extends BaseAdvancement {
    public FiveHundredThousandClickAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
