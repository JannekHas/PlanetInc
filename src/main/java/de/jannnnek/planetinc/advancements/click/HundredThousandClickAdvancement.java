...
public class HundredThousandClickAdvancement extends BaseAdvancement {
    public HundredThousandClickAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
