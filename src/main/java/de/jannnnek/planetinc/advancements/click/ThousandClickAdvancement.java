...
public class ThousandClickAdvancement extends BaseAdvancement {
    public ThousandClickAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
