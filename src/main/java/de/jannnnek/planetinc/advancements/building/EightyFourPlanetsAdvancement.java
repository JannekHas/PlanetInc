...
public class EightyFourPlanetsAdvancement extends BaseAdvancement {
    public EightyFourPlanetsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
