...
public class FiftySixPlanetsAdvancement extends BaseAdvancement {
    public FiftySixPlanetsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
