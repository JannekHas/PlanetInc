...
public class SevenPlanetsAdvancement extends BaseAdvancement {
    public SevenPlanetsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
