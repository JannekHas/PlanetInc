...
public class TwoHundredTwentyFourPlanetsAdvancement extends BaseAdvancement {
    public TwoHundredTwentyFourPlanetsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
