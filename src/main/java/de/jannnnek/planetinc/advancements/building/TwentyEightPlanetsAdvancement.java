...
public class TwentyEightPlanetsAdvancement extends BaseAdvancement {
    public TwentyEightPlanetsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
