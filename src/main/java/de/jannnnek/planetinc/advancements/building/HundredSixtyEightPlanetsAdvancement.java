...
public class HundredSixtyEightPlanetsAdvancement extends BaseAdvancement {
    public HundredSixtyEightPlanetsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
