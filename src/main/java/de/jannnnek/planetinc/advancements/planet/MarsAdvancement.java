...
public class MarsAdvancement extends BaseAdvancement {
    public MarsAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
