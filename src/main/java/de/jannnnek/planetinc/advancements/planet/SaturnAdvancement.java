...
public class SaturnAdvancement extends BaseAdvancement {
    public SaturnAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
