...
public class VenusAdvancement extends BaseAdvancement {
    public VenusAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
