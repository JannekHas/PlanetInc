...
public class UranusAdvancement extends BaseAdvancement {
    public UranusAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
