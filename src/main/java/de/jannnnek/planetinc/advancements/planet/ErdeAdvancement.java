...
public class ErdeAdvancement extends BaseAdvancement {
    public ErdeAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
