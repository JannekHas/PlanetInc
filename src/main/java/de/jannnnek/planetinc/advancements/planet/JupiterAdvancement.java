...
public class JupiterAdvancement extends BaseAdvancement {
    public JupiterAdvancement(String key, AdvancementDisplay display, Advancement parent, int maxProgression) {
